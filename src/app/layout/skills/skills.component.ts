...
export class SkillsComponent implements OnInit {
  ...
  cards = [
    ...
    content:"This area is one I am least skilled at, but I can create quite compeling, easy to navigate and good looking webpages. Still I need to get some more expirence creating expirences for the users to become proficient with Design "}]
